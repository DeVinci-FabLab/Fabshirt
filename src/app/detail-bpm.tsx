...
export default function DetailBpmScreen() {
  const router = useRouter();
  const params = useLocalSearchParams();
  const data = params.bpm ? JSON.parse(params.bpm) : {
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoTexte}>
            ...
            Au repos elle est entre 60 et 100 bpm. Pendant l'effort elle peut monter jusqu'à 180-200 bpm.
            Une FC élevée longtemps indique un effort intense.
          </Text>
        </View>
      </ScrollView>
    </View>
