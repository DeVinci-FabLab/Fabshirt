...
export default function DetailTranspirationScreen() {
  const router = useRouter();
  const params = useLocalSearchParams();
  const data = params.transpi ? JSON.parse(params.transpi) : {
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoTexte}>
            La transpiration mesure le niveau d'humidité cutanée via le t-shirt. 
            Un taux élevé indique un effort intense ou une température ambiante haute.
            Elle permet d'estimer la perte hydrique pour adapter ta réhydratation.
          </Text>
        </View>
      </ScrollView>
    </View>
